...
**NOTE** 📝 Please check the \object_detection\protos directory after running the above code,it should have both .proto and _pb2.py at the end of the each files. If there is missing python file, rerun the proto file name that does not have a python file with the protoc command as above.
